 ...
 * X.Y.Z => Release versioning format
  ...
  - perf(pencil): mid level changes released => Will bump the X

  - BREAKING CHANGE: major features released  => Will bump the Y
...
module.exports = {
  ...
  rules: {
    'body-max-line-length': [0, 'always', Infinity], // added this due to semantic release bug will be adding semantic release later down the line
  },
};
